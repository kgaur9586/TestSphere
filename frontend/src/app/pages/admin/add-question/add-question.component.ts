...
export class AddQuestionComponent  implements OnInit{
  ...
  constructor(private route:ActivatedRoute,private snack:MatSnackBar,private router:Router,private quizService:QuizService,private questionService:QuestionService){}
  ...
  public addQuestion(question:any){
    if(question.answer.trim() == '' || question.answer == null){
      this.snack.open("Please Select answer!!",'',{duration:3000,verticalPosition:'top'});
      return;
    }
    this.questionService.addQuestionTOQuiz(question).subscribe((data) => {
      ...
      Swal.fire("Error!","Some error occured , try again !",'error');
    })
  }
